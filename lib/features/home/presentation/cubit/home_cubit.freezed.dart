...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<AccountModel> accounts) : _accounts = accounts;
  ...
  @override
  String toString() {
    return 'HomeState.loaded(accounts: $accounts)';
  }
...
abstract class _Loaded implements HomeState {
  const factory _Loaded(final List<AccountModel> accounts) = _$LoadedImpl;
